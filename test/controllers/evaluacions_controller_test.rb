...
class EvaluacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluacion" do
    assert_difference('Evaluacion.count') do
      post evaluacions_url, params: { evaluacion: { calificacion: @evaluacion.calificacion, calificador: @evaluacion.calificador, login_unal: @evaluacion.login_unal, num_servicio: @evaluacion.num_servicio, responsable: @evaluacion.responsable } }
    end
  ...
  test "should update evaluacion" do
    patch evaluacion_url(@evaluacion), params: { evaluacion: { calificacion: @evaluacion.calificacion, calificador: @evaluacion.calificador, login_unal: @evaluacion.login_unal, num_servicio: @evaluacion.num_servicio, responsable: @evaluacion.responsable } }
