...
class SolicitudsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solicitud" do
    assert_difference('Solicitud.count') do
      post solicituds_url, params: { solicitud: { codigo_solicitud: @solicitud.codigo_solicitud, oficina: @solicitud.oficina, solicitante: @solicitud.solicitante, tipo: @solicitud.tipo, urgencia: @solicitud.urgencia } }
    end
  ...
  test "should update solicitud" do
    patch solicitud_url(@solicitud), params: { solicitud: { codigo_solicitud: @solicitud.codigo_solicitud, oficina: @solicitud.oficina, solicitante: @solicitud.solicitante, tipo: @solicitud.tipo, urgencia: @solicitud.urgencia } }
