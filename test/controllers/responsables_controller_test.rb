...
class ResponsablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsable" do
    assert_difference('Responsable.count') do
      post responsables_url, params: { responsable: { login_responsable: @responsable.login_responsable, nombre_responsable: @responsable.nombre_responsable } }
    end
  ...
  test "should update responsable" do
    patch responsable_url(@responsable), params: { responsable: { login_responsable: @responsable.login_responsable, nombre_responsable: @responsable.nombre_responsable } }
